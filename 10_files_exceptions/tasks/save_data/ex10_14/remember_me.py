...
relative_filepath= '10_files_exceptions/tasks/save_data/ex10_14/'
...
def check_name():
    ...
    while(True):
        result = input('Are your name right? Press y/n ')
        if  result == "y" or result == 'n':
            return result
            
        #else:
         #   print("Wrong answer! Need y, n")
